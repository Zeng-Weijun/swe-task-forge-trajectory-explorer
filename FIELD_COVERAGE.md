...
```
mining run (bench_worker)  ──1──►  minions_v148_pack_20260911  ──2──►  pack/explorer/*.js  ──3──►  this repo
   manifests 01..10                 tasks/*/task/**                    (v1 exporter)          (v2 exporter)
   full codex stdout                trace.jsonl (capped)
```

---

## Layer 3 — the exporter shipped inside the pack (`pack/explorer/trajectory-data.js`)

This is the layer this repo replaces. It was the largest loss.
